...
for dev in config['devices']:
    ...
    for init in config['acl']:
        ...
        if os.path.isdir(map_dir):
            log.write('[WARNING] Sysfs entry for lun-map already exists: ' + map_dir + '\n')
            log.write('[WARNING] Skipping creation of entire lun-map with symlink...\n')
        else:
